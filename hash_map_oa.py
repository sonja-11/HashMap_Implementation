...
# Assignment: 6
# Due Date: 12/07/2023
# Description: HashMap Implementation using a dynamic array to store the hash table, and implementing Open Addressing
...
class HashMap:
    ...
    def get(self, key: str) -> object:
        ...
        for i in range(self.get_capacity()):
            ...
            if bucket is not None and not bucket.is_tombstone and bucket.key == key:
                return bucket.value
